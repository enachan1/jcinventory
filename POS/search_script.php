...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM items_db WHERE CONCAT(item_sku,item_name,item_category,item_stocks,item_price,item_barcode) LIKE '%$filtervalues%'";
    $query_run = mysqli_query($con, $query);

    foreach ($query_run as $items) {
        echo '<tr class="search-result" data-sku="' . $items['item_sku'] . '" data-barcode="' . $items['item_barcode'] . '">';
